...
def VGG11(input_shape, num_classes):
  ...
  # Block 1
  block_1 = vgg_module(1, 64, (3,3), 'same', tf.nn.relu)
  layers += block_1

  # Block 2
  block_2 = vgg_module(1, 128, (3,3), 'same', tf.nn.relu)
  layers += block_2

  # Block 3
  block_3 = vgg_module(2, 256, (3,3), 'same', tf.nn.relu)
  layers += block_3

  # Block 4
  block_4 = vgg_module(2, 512, (3,3), 'same', tf.nn.relu)
  layers += block_4

  # Block 5
  block_5 = vgg_module(2, 512, (3,3), 'same', tf.nn.relu)
  layers += block_5
